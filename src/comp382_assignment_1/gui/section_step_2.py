...
class SectionStep2(QWidget):
    ...
    def setup_ui(self):
        ...
        # Result Label (Simplified: Accepted/Rejected)
        self.result_label = QLabel("Accepted") 
        self.result_label.setObjectName("ResultLabel")
        self.result_label.setFixedWidth(100) # Give it some fixed space
        input_row.addWidget(self.result_label)
